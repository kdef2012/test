  ...
  return (
    <div style={{ background: COLORS.black, minHeight: "100vh", color: COLORS.white, fontFamily: "'Outfit', sans-serif" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", borderBottom: `4px solid ${COLORS.red}` }}>
         <div style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, background: "url('/knights-logo1.png') no-repeat center bottom", backgroundSize: "cover", zIndex: 0, mixBlendMode: "overlay", opacity: 0.15, filter: "grayscale(100%)" }} />
         <div style={{ position: "relative", zIndex: 10, maxWidth: 1200, margin: "0 auto", padding: "80px 20px 40px", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
           <img src="/knights-logo1.png" alt="Krown Knights Official Mascot" style={{ width: 220, height: "auto", marginBottom: 20, filter: "drop-shadow(0 10px 30px rgba(196,30,30,0.4))" }} />
