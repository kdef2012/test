  ...
  return (
    <div style={{ background: COLORS.black, minHeight: "100vh", color: COLORS.white, fontFamily: "'Outfit', sans-serif" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", borderBottom: `4px solid ${COLORS.red}` }}>
         <div style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, background: "url('/knights-logo.jpg') no-repeat center bottom", backgroundSize: "cover", zIndex: 0, mixBlendMode: "overlay", opacity: 0.15, filter: "grayscale(100%)" }} />
